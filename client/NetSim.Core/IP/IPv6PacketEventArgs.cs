...
/// <summary>
/// Payload for the <see cref="IIPv6Layer"/> notifications (<c>PacketCreated</c> /
/// <c>PacketEncapsulated</c> / <c>PacketProcessed</c> / <c>PacketDropped</c>). A plain data carrier,
/// following the same Core-stays-dispatch-agnostic pattern as <see cref="IPv4PacketEventArgs"/> and
/// <see cref="Ethernet.EthernetFrameEventArgs"/> - the real consumers (packet visualization, event
/// timeline, monitoring, AI diagnostics) arrive in later phases.
/// </summary>
public sealed class IPv6PacketEventArgs : EventArgs
{
    public IPv6PacketEventArgs(
        IPv6Packet packet,
    ...
    /// <summary>The IPv6 packet the event is about.</summary>
    public IPv6Packet Packet { get; }
